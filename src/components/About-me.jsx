...
const  Aboutme = () => (
    <div className="flex flex-col justify-center m-auto text-lightGray text-4xl lg:text-6xl sm:text-5xl max-w-screen-lg" id="about-me">
        ...
        <div className="flex flex-row justify-between">
            <span className="text-xl sm:text-2xl w-10/12 sm:w-7/12 m-auto lg:m-0 text-lightWhite">
                ...
                <div className="my-4">With making websites I put a lot attention in to the details so everything looks and works perfectly.</div>
